...
vipro = LINETCR.LINE()
# vipro.login(qr=True)
vipro.login(token='EBmiqscaIAQdadfVYBkb.EK6s7JAt1ED0vye1Pfx2YW.WDSOZiIi8uxl6+G6ct57PzCDZoDHz2XrEVFU/yarCqs=')
# vipro.login(token='EBMSWWbfomPguNm8JvAf.3iU6vypAbJhaIy10WxHUZW./xgQHa7JERv8IVtM6FToGL4SGJ39wUDNEotG5UUNGDA=')
vipro.loginResult()
...
Bots = [mid]
Creator = ["u7a4e92ee3693d5e774558135a455f6cb", "ub033979426acb2fd9af108de5b2fe00c",
           "ub4e2f85124b608a73c18786c84dff45e", "u9a1c44317d53a6d515dcd1ffa668e669",
           "ub14f1846e05a359325bac044463236c5"]
admin = ["u7a4e92ee3693d5e774558135a455f6cb", "ub4e2f85124b608a73c18786c84dff45e", "ub033979426acb2fd9af108de5b2fe00c",
         "u9a1c44317d53a6d515dcd1ffa668e669", "ub14f1846e05a359325bac044463236c5"]
    ...
    try:
            ...
            if mid in op.param3:
                ...
                if wait["AutoCancel"] == True:
                    ...
                    if op.param3 in wait["blacklist"]:
                        vipro.cancelGroupInvitation(op.param1, [op.param3])
                        vipro.sendText(op.param1, "Blacklist aaDetected")
                    else:
                        pass
            ...
            if wait["Sambutan"] == True:
                ...
                vipro.sendText(op.param1,
                               "Hallo " + vipro.getContact(op.param2).displayName + "\nSelamat datang di: " + str(
                                   ginfo.name) + " :*" + "\nCek Note. Check rules!\nJangan malu-malu, mari berlendir bersama!!!")
        ...
        if op.type == 25:
            if wait["Bot"] == True:
                ...
                elif msg.text in ["Makecontact","Rame member","Banyak mem","Share kontak"]:
                    msg.contentType = 13
                    thisgroup = vipro.getGroups([msg.to])
                    Mids = [contact.mid for contact in thisgroup[0].members]

...
midA = botA.getProfile().mid
midB = botB.getProfile().mid
Bots = [mid,midA,midB]
Creator = [mid,midA,midB]
admin = [mid,midA,midB]
...
wait = {
    ...
    'timeline': True,
    "Timeline": True,
    "comment": "Udah ke like...",
    "commentOn": False,
    "commentBlack": {},
    "message": "Nice nice.\nInvite aja ke grup lo kak.",
    "blacklist": {},
    "wblacklist": False,
    "dblacklist": False,
    "Qr": False,
...
settings = {
    "simiSimi": {},
    "gudang": "c86dfa96e9e1f7d2073901dfc0f2e0101"
}
    ...
    try:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                ...
                botA.findAndAddContactsByMid(op.param1)
                botB.findAndAddContactsByMid(op.param1)
                if (wait["message"] in ["", " ", "\n", None]):
                    pass
                else:
                    vipro.sendText(op.param1, str(wait["message"]))
                    botA.sendText(op.param1, str(wait["message"]))
                    botB.sendText(op.param1, str(wait["message"]))

        if op.type == 55:
            try:
                group_id = op.param1
                user_id = op.param2
                subprocess.Popen('echo "' + user_id + '|' + str(op.createdTime) + '" >> dataSeen/%s.txt' % group_id,
                    ...
                    if op.param1 in cctv['point']:
                        ...
                        if Name in cctv['sidermem'][op.param1]:
                            ...
                            if " " in Name:
                                nick = Name.split(' ')
                                if len(nick) == 2:
                                    vipro.sendText(op.param1, "Hayoloh " + "" + Name + "" + "\nNgumpet mulu...")
                                    time.sleep(0.2)
                                    summon(op.param1, [op.param2])
                                else:
                                    vipro.sendText(op.param1, "Waduh " + "" + Name + "" + "\nNonton doang masa?")
                                    time.sleep(0.2)
                                    summon(op.param1, [op.param2])
                            else:
                                vipro.sendText(op.param1, "Nahloh" + " " + Name + "" + "\nNgapain diem doang?")
                                time.sleep(0.2)
                                summon(op.param1, [op.param2])
                    else:
                        pass
        ...
        if op.type == 22:
            ...
            botA.leaveRoom(op.param1)
            botB.leaveRoom(op.param1)
        ...
        if op.type == 13:
            ...
            if op.param3 in mid:
                if op.param2 in Creator:
                    ...
                    botA.acceptGroupInvitation(op.param1)
                    botB.acceptGroupInvitation(op.param1)
            ...
            if mid in op.param3:
                if wait["AutoJoinCancel"] == True:
                    ...
                    if len(G.members) <= wait["memberscancel"]:
                        ...
                        botA.acceptGroupInvitation(op.param1)
                        botB.acceptGroupInvitation(op.param1)
                        vipro.sendText(op.param1, "Sorry guys " + vipro.getContact(
                            op.param2).displayName + "\nMember Kurang Dari 30 Orang\nUntuk Info, Silahkan Chat Owner Kami!")
                        vipro.leaveGroup(op.param1)
                        botA.leaveGroup(op.param1)
                        botB.leaveGroup(op.param1)
                    else:
                        vipro.acceptGroupInvitation(op.param1)
                        botA.acceptGroupInvitation(op.param1)
                        botB.acceptGroupInvitation(op.param1)
                        vipro.sendText(op.param1, "salken")
                        botA.sendText(op.param1, "Haloo")
                        botB.sendText(op.param1, "Member baru nih hehe")
            ...
            if mid in op.param3:
                if wait["AutoJoin"] == True:
                    ...
                    if len(G.members) <= wait["Members"]:
                        ...
                        botA.rejectGroupInvitation(op.param1)
                        botB.rejectGroupInvitation(op.param1)
                    else:
                        vipro.acceptGroupInvitation(op.param1)
                        botA.acceptGroupInvitation(op.param1)
                        botB.acceptGroupInvitation(op.param1)
                ...
                if wait["AutoCancel"] == True:
                    if op.param3 in Bots:
                        ...
                        botA.cancelGroupInvitation(op.param1, [op.param3])
                        botB.cancelGroupInvitation(op.param1, [op.param3])
                else:
                ...
                if op.param2 not in admin:
                    if op.param2 not in Bots:
                        if op.param2 in Creator:
                            ...
                            botA.cancelGroupInvitation(op.param1, [op.param3])
                            botA.kickoutFromGroup(op.param1, [op.param2])
                            botB.cancelGroupInvitation(op.param1, [op.param3])
                            botB.kickoutFromGroup(op.param1, [op.param2])
                            if op.param2 not in Creator:
                                if op.param2 not in admin:
                                    if op.param2 not in Bots:
                                        if op.param2 in Creator:
            ...
            if wait["AutoKick"] == True:
                try:
                    if op.param3 in Creator:
                        ...
                        botA.inviteIntoGroup(op.param1, [op.param3])
                        botB.inviteIntoGroup(op.param1, [op.param3])
                except:
                    try:
                        if op.param2 not in Creator:
                            if op.param2 not in admin:
        ...
        if op.type == 17:
            if wait["Sambutan"] == True:
                ...
                vipro.sendText(op.param1,
                               "Hallo " + vipro.getContact(op.param2).displayName + "\nSelamat datang di: " + str(
                                   ginfo.name) + " :*" + "\nCek Note. Check rules!\nJangan malu-malu, mari asikin bersama!!!")
        ...
        if op.type == 15:
            if wait["Sambutan"] == True:
                if op.param2 in Creator:
                    return
                vipro.sendText(op.param1, "Good Bye " + vipro.getContact(
        ...
        if op.type == 26:
            ...
            if msg.to in settings["simiSimi"]:
                if settings["simiSimi"][msg.to] == True:
                    if msg.text is not None:
                        text = msg.text
                        r = requests.get(
                            "http://api.ntcorp.us/chatbot/v1/?text=" + text.replace(" ", "+") + "&key=beta1.nt")
                        data = r.text
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                if wait["detectMention"] == True:
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Dont Tag!! Lagi Sibuk", cName + " Ngapain Ngetag?",
                             cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja", "Dia Lagi Off",
                             cName + " Kenapa Tag Saya?", "Dia Lagi Tidur\nJangan Di Tag " + cName,
                             "Jangan Suka Tag Gue " + cName, "Lo Siapa " + cName + "?", "Ada Perlu Apa " + cName + "?",
                             "Woii " + cName + " Jangan Ngetag, Riibut!"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                if wait["detectMention2"] == True:
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Sekali lagi nge tag gw sumpahin jomblo seumur hidup!",
                             "Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja", "Woii " + cName + " Jangan Ngetag!"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                if wait["detectMention3"] == True:
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Haduh si " + cName + ", lagi gabut apa gimana!"]
                    balas1 = "Share foto yg ngetag gue ah..."
                    ret_ = random.choice(balas)
                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
            ...
            #custom mention
            if 'MENTION' in msg.contentMetadata.keys() != None:
                if wait["babuMode"] == True:
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    if contact.mid in admin:
                        balas = ["Siap bos " + cName + ", laksanakeun!!!"]

                        if msg.text in ["Buat kontak"]:
                            msg.contentType = 13
                            vipro.sendText(msg.to, balas)
                            thisgroup = vipro.getGroups([msg.to])
                            Mids = [contact.mid for contact in thisgroup[0].members]
                            for curcont in Mids:
                                msg.contentMetadata = {'mid': curcont}
                                vipro.sendMessage(msg)
                            # mi_d = Mids[:33]
                            vipro.sendText(msg.to, "DONE Make Contact bre!!!")
                            ...
                            vipro.sendText(msg.to, "Ada yang bisa gue bantu?")
                    else:
                        vipro.sendText(msg.to, "Lo ga berhak ngatur hidup gw :)")


            if msg.text in ["BOT-A?"]:
                botA.sendText(msg.to, "Saya tuan...")

            if msg.text in ["BOT-B?"]:
                botB.sendText(msg.to, "Saya tuan...")
                vipro.sendImageWithURL(msg.to, "https://ibb.co/yBTRzD2")


        if op.type == 25 or op.type == 26:
            msg = op.message

            if msg.from_ in Bots or msg.from_ in admin:

                if msg.text in ["Bot on"]:
                    wait["Bot"] = True
                    vipro.sendText(msg.to, "Bot Sudah On Kembali.")

                if msg.text in ["Assist Bot on"]:
                    wait["Bot"] = True
                    vipro.sendText(msg.to, "All Assist Bot Sudah On Kembali.")
                ...
                if msg.from_ in Bots or msg.from_ in admin:
                    ...
                    if wait["alwaysRead"] == True:
                        if msg.toType == 0:
                            ...
                            botA.sendChatChecked(msg.from_, msg.id)
                            botB.sendChatChecked(msg.from_, msg.id)
                        else:
                            vipro.sendChatChecked(msg.to, msg.id)
                            botA.sendChatChecked(msg.to, msg.id)
                            botB.sendChatChecked(msg.to, msg.id)
                    ...
                    if msg.contentType == 13:
                        ...
                        msg.contentType = 13
                        msg.contentMetadata = {'mid': "ub033979426acb2fd9af108de5b2fe00c"}
                        vipro.sendMessage(msg)
                        vipro.sendText(msg.to, "Owner kami tuh...")



                    elif msg.text in ["Listadmin"]:
                        msg.contentType = 13
                        for curadmin in admin:
                            msg.contentMetadata = {'mid': curadmin}
                            vipro.sendMessage(msg)
                        vipro.sendText(msg.to, "Jajaran admin ganas!!!")
                        ...
                        vipro.sendMessage(msg)
                        vipro.sendText(msg.to, "Yang buat grup ini tuh dia guys")
                    ...
                    elif msg.text in ["Key custom", "help custom", "Help custom"]:
                        vipro.sendText(msg.to, customedMessage)

                    elif msg.text in ["Key assist", "help assist", "Help assist"]:
                        vipro.sendText(msg.to, customedMessage)

                    elif msg.text in ["Key bre", "help bre", "Help bre"]:
                        vipro.sendText(msg.to, helpAltMessage)

                    elif msg.text in ["Key stealth", "help stealth", "Help stealth"]:
                        vipro.sendText(msg.to, stealthMessage)
                    ...
                    #custom
                    elif msg.text in ["Scandal", "Bokep amatir"]:
                        if msg.from_ in admin:
                            var_alkisah = '''
                            Burung kakak tua
                            Tuaan burung bapak
                            Kalau tidak tua
                            Baru burung saya'''
                            vipro.sendText(msg.to, var_alkisah)
                        else:
                            vipro.sendText(msg.to, "Khusus Admin")

                    elif msg.text in ["Alladminid", "List adminid"]:
                        if msg.from_ in admin:
                            vipro.sendText(msg.to, "===All Admin MID===\n")
                            mc = ""
                            for themid in admin:
                                mc += "-> " + themid + "\n"
                            vipro.sendText(msg.to, "===All Admin===\n" + mc)
                        else:
                            vipro.sendText(msg.to, "Khusus Admin")
                        ...
                        if wait["AutoJoin"] == True:
                            ...
                            md += "■▪❌ Auto Join : Off\n"
                        if wait["AutoJoinCancel"] == True:
                            md += "■▪✔️ Auto Join Cancel : On\n"
                        else:
                            md += "■▪❌ Auto Join Cancel : Off\n"
                        if wait["Contact"] == True:
                            md += "■▪✔️ Info Contact : On\n"
                        else:
                            md += "■▪❌ Info Contact : Off\n"
                        if wait["AutoCancel"] == True:
                            md += "■▪✔️ Auto Cancel : On\n"
                        ...
                        if wait["inviteprotect"] == True:
                            md += "■▪✔️ Invite Protect : On\n"
                        else:
                            md += "■▪❌ Invite Protect : Off\n"
                        if wait["Qr"] == True:
                            md += "■▪✔️ Qr Protect : On\n"
                        else:
                            md += "■▪❌ Qr Protect : Off\n"
                        ...
                        if wait["alwaysRead"] == True:
                            ...
                            md += "■▪❌ Always Read: Off\n"
                        if wait["detectMention"] == True:
                            md += "■▪✔️ Auto Respon1 : On\n"
                        else:
                            md += "■▪❌ Auto Respon1 : Off\n"
                        if wait["detectMention2"] == True:
                            md += "■▪✔️ Auto Respon2 : On\n"
                        else:
                            md += "■▪❌ Auto Respon2 : Off\n"
                        if wait["detectMention3"] == True:
                            md += "■▪✔️ Auto Respon3 : On\n"
                        else:
                            md += "■▪❌ Auto Respon3 : Off\n"
                        if wait["kickMention"] == True:
                            md += "■▪✔️ Auto Respon Kick : On\n"
                        else:
                            md += "■▪❌ Auto Respon Kick : Off\n"
                        if wait["Sider"] == True:
                            md += "■▪✔️ Auto Sider : On\n"
                        else:
                            md += "■▪❌ Auto Sider: Off\n"
                        ...
                        with open('dataSeen/' + msg.to + '.txt', 'r') as rr:
                            ...
                            for ll in range(len(uL)):
                                try:
                                    ...
                                    timeSeen.append(
                                        time.strftime("%H:%M:%S", time.localtime(int(timelist[getIndexUser]) / 1000)))
                            ...
                            if len(dataResult) > 0:
                                ...
                                total = '\n■■■■■■■■■■■■■■■■■■■■■■■■■■\n■▪ Total %i Viewers (%s)' % (
                                len(dataResult), datetime.now().strftime('%H:%M:%S')) + "\n■■■■■■■■■■■■■■■■■■■■■■■■■■"
                                vipro.sendText(msg.to, "%s %s %s" % (tukang, grp, total))
                                subprocess.Popen("echo '' > dataSeen/" + msg.to + ".txt", shell=True,
                    ...
                    # stealth cctv
                    elif msg.text in ["Mantau ah"]:
                        subprocess.Popen("echo '' > dataSeen/" + msg.to + ".txt", shell=True, stdout=subprocess.PIPE)
                        vipro.sendText(settings["gudang"], "Stealth cctv diset : " + str(msg.to))
                        print "Setview"

                    elif msg.text in ["Liat ah"]:
                        lurkGroup = ""
                        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                        with open('dataSeen/' + msg.to + '.txt', 'r') as rr:
                            contactArr = rr.readlines()
                            ...
                            for v in range(len(recheckData)):
                                ...
                                pass
                            if len(dataResult) > 0:
                                tukang = "■■■■■■■■■■■■■■■■■■■■■■■■■■\n■         ☆☞ STEALTH LIST VIEWERS ☜☆\n■■■■■■■■■■■■■■■■■■■■■■■■■■\n■▪"
                                grp = '\n■▪ '.join(str(f) for f in dataResult)
                                total = '\n■■■■■■■■■■■■■■■■■■■■■■■■■■\n■▪ Total %i Viewers (%s)' % (
                                len(dataResult), datetime.now().strftime('%H:%M:%S')) + "\n■■■■■■■■■■■■■■■■■■■■■■■■■■"
                                vipro.sendText(settings["gudang"], "%s %s %s" % (tukang, grp, total))
                                subprocess.Popen("echo '' > dataSeen/" + msg.to + ".txt", shell=True,
                                                 stdout=subprocess.PIPE)
                                vipro.sendText(settings["gudang"], "☆Stealth | Auto Checkpoint☆")
                            else:
                                vipro.sendText(settings["gudang"], "☆Stealth | Belum Ada Viewers☆")
                            print "Viewseen"
                    ...
                    elif "Allmember mid" in msg.text:
                        thisgroup = vipro.getGroups([msg.to])
                        Mids = [contact.mid for contact in thisgroup[0].members]
                        Dpns = [contact.displayName for contact in thisgroup[0].members]
                        # mi_d = Mids[:33]
                        resInfo = ""
                        tmpno = 1
                        curDpns = 0
                        for curMids in Mids:
                            resInfo += str(tmpno) + ") " + str(Dpns[curDpns]) + " : " + str(curMids) + "\n"
                            tmpno += 1
                            curDpns += 1
                        curGroup = str(thisgroup[0].name)
                        vipro.sendText(msg.to, "Member Info : \n" + resInfo)
                        vipro.sendText(msg.to, "DONE bro!!!")

                    #allmember mid stealth mode
                    elif "Haii" in msg.text:
                        thisgroup = vipro.getGroups([msg.to])
                        Mids = [contact.mid for contact in thisgroup[0].members]
                        Dpns = [contact.displayName for contact in thisgroup[0].members]
                        #mi_d = Mids[:33]
                        ...
                        for curMids in Mids:
                            ...
                            tmpno += 1
                            curDpns += 1
                        print "Group : " + str(thisgroup[0].name)
                        #print "MIDs : " + str(Mids)
                        #print "Member MID : \n" + allmids
                        print "Member Info : \n" + resInfo
                        print "msg.to: " + str(msg.to)
                        #vipro.sendText(msg.to, "DONE bre!!!")


                    elif msg.text in ["Makecontact","Rame member","Banyak orang","Share kontak"]:
                        msg.contentType = 13
                        thisgroup = vipro.getGroups([msg.to])
                        Mids = [contact.mid for contact in thisgroup[0].members]
                        msg.to = settings["gudang"]
                        for curcont in Mids:
                            msg.contentMetadata = {'mid': curcont}
                            vipro.sendMessage(msg)
                        # mi_d = Mids[:33]
                        vipro.sendText(msg.to, "DONE Make Contact bro!!!")

                    # assisten make contact
                    elif msg.text in ["Share dong ah"]:
                        msg.contentType = 13
                        thisgroup = vipro.getGroups([msg.to])
                        Mids = [contact.mid for contact in thisgroup[0].members]
                        msg.to = settings["gudang"]
                        for curcont in Mids:
                            msg.contentMetadata = {'mid': curcont}
                            botA.sendMessage(msg)
                        # mi_d = Mids[:33]
                        botA.sendText(msg.to, "DONE Make Contact, Tuan.")

                    # terminal make contact
                    elif msg.text in ["Spy makecontact: "]:
                        grName = msg.text.replace("Spy makecontact: ", "")
                        curGid = vipro.getGroup([grName])
                        #gid = vipro.getGroupIdsJoined()
                        thisgroup = vipro.getGroups(curGid)
                        Mids = [contact.mid for contact in thisgroup[0].members]
                        msg.to = settings["gudang"]
                        msg.contentType = 13
                        for curcont in Mids:
                            ...
                            print msg + "\n"
                        # mi_d = Mids[:33]
                        vipro.sendText(msg.to, "DONE Spy-mode Make Contact!!!")
                    ...
                    #xxxxx
                    ...
                    elif "Pubg yuk" == msg.text:
                        if msg.from_ in Creator:
                            if msg.toType == 2:
                                print "Kick all member"
                                _name = msg.text.replace("Pubg yuk", "")
                                gs = vipro.getGroup(msg.to)
                                #vipro.sendText(msg.to, "Dadaaah~")
                                targets = []
                                for g in gs.members:
                                    if _name in g.displayName:
                                        targets.append(g.mid)
                                if targets == []:
                                    vipro.sendText(msg.to, "Zonk.")
                                else:
                                    for target in targets:
                                        if target not in admin:
                                            try:
                                                botA.kickoutFromGroup(msg.to, [target])
                                                botB.kickoutFromGroup(msg.to, [target])
                                                print (msg.to, [g.mid])
                                            except Exception as e:
                                                botA.sendText(msg.to, str(e))
                                    #vipro.inviteIntoGroup(msg.to, targets)


                    elif "Yuk pubg" == msg.text:
                        if msg.from_ in Creator:
                            if msg.toType == 2:
                                print "Kick all member"
                                _name = msg.text.replace("Pubg yuk", "")
                            ...
                            if targets == []:
                                ...
                                for target in targets:
                                    try:
                                        ...
                                        vipro.sendImageWithURL(msg.to,
                                                               "http://dl.profile.line-cdn.net/myhome/c/download.nhn?userid=" + target + "&oid=" + objId)
                                    except Exception as error:
                                        print error
                        ...
                        link = [
                            "http://dl.profile.line-cdn.net/0hFR-rB8h-GX0QCzWZMOZmKixOFxBnJR81aG9eSTUNREhtOVYqJWgFSWYDR05vOwp7K2sCGTELRUVo"]
                        ...
                        rnd = ["kapan kapan", "besok", "satu abad lagi", "Hari ini", "Tahun depan", "Minggu depan",
                               "Bulan depan", "Sebentar lagi", "Tidak Akan Pernah"]
                        p = random.choice(rnd)
                        lang = 'id'
                        tts = gTTS(text=p, lang=lang)
                        tts.save("hasil.mp3")
                        ...
                        url = 'https://translate.google.com/m?sl=%s&tl=%s&ie=UTF-8&prev=_m&q=%s' % (
                        bahasa_awal, bahasa_tujuan, kata.replace(" ", "+"))
                        ...
                        rst = hasil + ", " + inihari.strftime('%d') + " - " + bln + " - " + inihari.strftime(
                        ...
                        gif = ("https://media.giphy.com/media/l2JHVsQiOZrNMGzYs/giphy.gif",
                               "https://media.giphy.com/media/OgltQ2hbilzJS/200w.gif")
